...
public class SafeFrame extends Frame implements ActionListener, Context {
    ...
    private Button buttonAlarm = new Button("ALEARM");    // 按下警铃按钮
    private Button buttonPhone = new Button("CALL");    // 正常通话按钮
    private Button buttonExit = new Button("OVER");         // 结束按钮
